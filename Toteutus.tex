...
Kuutiollisen skaalautumisen syitä pitää etsiä \verb|findMatch|-kutsun tarkemmasta toteutuksesta, joka vaatii matchin aloitusindeksien tallennuksen ja päivityksen jokaisella askeleella. Koska jokaisen käsitellyn ja tulevan tilan aloitusindeksit on päivitettävä tasan kerran riippumatta siitä, kuuluuko tila jompaankumpaan vai kumpaankin joukoista currentStates ja nextStates, jokainen askel edellyttää \verb|currentStates|- ja \verb|nextStates|-joukkojen yhdistämistä, eli käytännössä n:n kokoisen joukon läpikäymistä kertaalleen duplikaattien eliminoimiseksi.
